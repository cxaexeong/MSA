...
urlpatterns = [
    ...
    django.urls.path('airport/<str:oi>/<str:c>/<str:start>/<str:end>/', views.airport_list, name="airport_list"),
    django.urls.path('house/<str:oi>/<str:c>/<str:start>/<str:end>/', views.house_list, name="house_list"),
