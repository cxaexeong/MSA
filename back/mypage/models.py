...
class RoomReservation(models.Model):
    ...
    user_id = models.ForeignKey(User, related_name="userroom", on_delete=models.CASCADE, db_column="user_id")
...
class FlightReservation(models.Model):
    ...
    user_id = models.ForeignKey(User, related_name="userflight", on_delete=models.CASCADE, db_column="user_id")
    oi_code = models.CharField(max_length=4)
    c_code = models.CharField(max_length=4)
